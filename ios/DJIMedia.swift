...
class DJIMedia: NSObject {
  ...
  @objc(startFullResMediaFileDownload:resolve:reject:)
  func startFullResMediaFileDownload(nameOfFileToDownload: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
