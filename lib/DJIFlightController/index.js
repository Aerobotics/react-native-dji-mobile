...
const DJIFlightController = {
  ...
  setGimbalRotation: async (pitch: number, roll: number, yaw: number, completionTime: number) => {
    return await FlightControllerWrapper.setGimbalRotation(pitch, roll, yaw, completionTime);
  }
};
