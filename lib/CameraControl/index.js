...
type IOSValues = 'AUTO' | '100' | '200' | '400' | '800' | '1600' | '3200' | '6400' | '3200' | '6400' | '12800' | '25600' | 'FIXED';

const iosValues = Object.freeze({
  '100': 'ISO_100',
  '200': 'ISO_200',
  '300': 'ISO_300',
  '400': 'ISO_400',
...
const CameraControl = {
  ...
  setISO: async (isoValue: IOSValues) => {
    return await CameraControlNative.setIOS(iosValues[iosValue]);
  },
